...
def usps(file1_path, file2_path, output_dir, remark_prefix, state):
...
if __name__ == '__main__':
    ...
    if select_channel_input == "1":
        ...
        ups(source_file, dst_path, output_dir, remark_prefixs, state)
        ...
        usps(source_file, dst_path, output_dir, remark_prefixs, state)
    else:
        print("🈚️此项功能！")
