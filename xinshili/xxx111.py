...
arr = ['Alert', 'Contact Customer Care at 1-800-275-8777', 'Processing Exception, Other Delay\n\nAugust 14, 2025, 12:00 pm', '\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\tOut for Delivery\n\t\t\t\t\t\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\tBLUEFIELD, WV 24701 \n\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tAugust 13, 2025,\n\t\t\t\t\t\t\t\t\t6:10 am\n\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t', ]

arr = ['Delivery Attempt: Action Needed', 'Reminder to Schedule Redelivery of your item before August 25, 2025\n\nAugust 16, 2025', 'Available for Pickup\n\nWHITMAN\n1125 WHITMAN CREEK RD\nWHITMAN WV 25652-9998\nM-F 0800-1200; SAT 0900-1100\n\nAugust 11, 2025, 8:36 am', '\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\tArrived at Post Office\n\t\t\t\t\t\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\tWHITMAN, WV 25652 \n\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tAugust 11, 2025,\n\t\t\t\t\t\t\t\t\t8:29 am\n\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t', ]
